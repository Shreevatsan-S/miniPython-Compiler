...
public final class AGreatComparisonOr extends PComparisonOr
{
    private PExpression _lpar_;
    private PExpression _rpar_;

    public AGreatComparisonOr()
    {
    }
    ...
    {
        ((Analysis) sw).caseAGreatComparisonOr(this);
    }
